      ...
      <div className="bg-gradient-to-br from-indigo-600 to-violet-700 dark:from-indigo-800 dark:to-violet-900 p-5 rounded-3xl shadow-lg shadow-indigo-100 dark:shadow-indigo-900/20 text-white transition-colors">
        ...
        <div className="flex flex-col gap-3">
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 bg-white dark:bg-slate-800 text-indigo-600 dark:text-indigo-400 py-3 rounded-2xl font-bold text-sm hover:bg-indigo-50 dark:hover:bg-slate-700 transition-all active:scale-95 shadow-sm dark:shadow-none"
          >
