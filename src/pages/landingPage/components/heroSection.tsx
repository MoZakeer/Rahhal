    ...
    >
      ...
      <div className="relative max-w-2xl">
        ...
        <div className="mt-6 flex gap-4">
          <button className="px-6 py-3 rounded-full bg-[var(--color-primary-600)] hover:bg-[var(--color-primary-700)] hover:scale-105
            active:scale-95 transition-all duration-300">
            Plan Your Trip
          </button>

          <button className="px-6 py-3 rounded-full border border-white hover:bg-white hover:text-black hover:scale-105
            active:scale-95 transition-all duration-300">
