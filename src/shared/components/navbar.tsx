      ...
      <div className="container mx-auto flex h-16 items-center justify-between px-4 md:px-6">
        ...
        <Link
          ...
          onClick={(e) => {
            ...
            // fetch latest feed data if we're already on feed page
              ...
              {navItems.map(({ icon: Icon, label, path }) => {
                ...
                return (
                  <Link
                    ...
                    className={`flex items-center gap-4 rounded-xl p-4 text-base font-semibold ${isActive
              ...
              {hasToken ? (
                <>
                  <button
                    ...
                    className="flex items-center gap-4 rounded-xl p-4 text-slate-600 hover:bg-slate-50 font-semibold cursor-pointer"
                  >
                  ...
                  <button
                    onClick={handleLogout}
                    className="flex items-center gap-4 rounded-xl bg-red-50 p-4 text-red-600 font-bold hover:bg-red-100 cursor-pointer"
                  >
