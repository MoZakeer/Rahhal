...
export default function FeedHeader({ onCreatePost }: Props) {
  return (
    <div className="flex flex-col gap-6 w-full">
      ...
      >
        <div className="h-12 w-12 rounded-2xl bg-indigo-50 dark:bg-indigo-500/10 flex items-center justify-center flex-shrink-0 group-hover:bg-indigo-600 dark:group-hover:bg-indigo-500 transition-all duration-300">
          <PenSquare className="h-6 w-6 text-indigo-600 dark:text-indigo-400 group-hover:text-white dark:group-hover:text-white transition-colors" />
        </div>
        ...
        <button className="p-3 rounded-2xl hover:bg-indigo-50 dark:hover:bg-indigo-500/20 text-indigo-500 dark:text-indigo-400 transition-all">
