...
const PostCardSkeleton: React.FC = () => {
  return (
    <motion.div 
      className="bg-white dark:bg-slate-900 rounded-xl shadow-sm p-4 border border-gray-100 dark:border-slate-800 transition-colors duration-300"
      initial={{ opacity: 0.5 }}
      animate={{ opacity: 1 }}
    ...
    >
      ...
      <div className="h-3 bg-gray-200 dark:bg-slate-800 rounded w-5/6 mb-2"></div>

      {/* Media */}
      <div className="w-full h-40 bg-gray-200 dark:bg-slate-800 rounded-lg mb-2"></div>
