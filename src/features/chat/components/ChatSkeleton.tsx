...
function ChatSkeleton() {
  ...
  return (
    <div className="flex flex-col w-full h-dvh overflow-hidden bg-gray-50">
      <div className="flex items-center gap-4 px-4 py-3 bg-white border-b border-gray-200 w-full h-18 shrink-0">
      ...
      <div className="p-4 bg-white border-t border-gray-200 flex gap-3 items-center shrink-0">
