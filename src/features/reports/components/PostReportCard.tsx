...
export const PostReportCard = ({ report }: Props) => {
  ...
  return (
    <div className="bg-white dark:bg-slate-600 shadow-sm rounded-xl p-5 border border-gray-300">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="flex flex-col gap-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-semibold text-gray-600">{report.userName}</h3>
          ...
          {/* Description */}
          <p className="text-gray-700 wrap-break-word line-clamp-2 bg-gray-100 dark:bg-gray-500 rounded-lg p-2">
            {report.description}
          </p>
        ...
        <div className="flex flex-col justify-center items-end">
          ...
          <button
            onClick={() => navigate(`/report_details/${report.id}?type=posts`)}
