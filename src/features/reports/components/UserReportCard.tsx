    ...
    <div className="bg-white dark:bg-slate-600 shadow-sm rounded-xl p-5 flex justify-between items-center border border-gray-300 ">
      <div>
        <div className="flex items-center gap-3">
          <img
            src={
              normalizeMediaUrl(report.reportedUserPicture) ||
              `https://ui-avatars.com/api/?name=${encodeURIComponent(report.reportedUserName)}`
            }
            alt="profile"
      ...
      <div className="flex flex-col items-end ">
        ...
        <button
          onClick={() =>
            navigate(`/report_details/${report.reportedUserId}?type=users`)
          }
